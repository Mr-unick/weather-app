...
const Weather = () => {
  ...
  return (
    <div className="container">
      <div className="box">
        <div className="imge">
          <img src={imges} alt="img" height="650" />
        </div>
        ...
        <div className="info">
          {btn === "search" && result && result.main ? ( // Check if result is defined and has the 'main' property
            <div id={id} className="info-box">
              <div className="icons">
                <img src={icon} height="100" width="100" />
              </div>
              <div className="info-row">
                <SettingsBrightness id="icn" />{" "}
                <h2>
              ...
              <div className="info-row">
                <Dehaze id="icn" /> <h2>Sky: {result.weather[0].main}</h2>
              </div>
              <div className="info-row">
                <Cloud id="icn" /> <h2>Clouds: {result.clouds.all}%</h2>
              </div>
            </div>
          ) : null}
        </div>
